...
func (c *aPIClient) Get(ctx context.Context, in *ID, opts ...grpc.CallOption) (*Data, error) {
	out := new(Data)
	err := c.cc.Invoke(ctx, "/elastic.transfer.API/Get", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *aPIClient) Lists(ctx context.Context, in *IDs, opts ...grpc.CallOption) (*DataLists, error) {
	out := new(DataLists)
	err := c.cc.Invoke(ctx, "/elastic.transfer.API/Lists", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *aPIClient) All(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*IDs, error) {
	out := new(IDs)
	err := c.cc.Invoke(ctx, "/elastic.transfer.API/All", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *aPIClient) Put(ctx context.Context, in *Data, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	err := c.cc.Invoke(ctx, "/elastic.transfer.API/Put", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *aPIClient) Delete(ctx context.Context, in *ID, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, "/elastic.transfer.API/Delete", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _API_Get_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/elastic.transfer.API/Get",
	}
...
func _API_Lists_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/elastic.transfer.API/Lists",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _API_All_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/elastic.transfer.API/All",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _API_Put_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/elastic.transfer.API/Put",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _API_Delete_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/elastic.transfer.API/Delete",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
